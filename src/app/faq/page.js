...
export const metadata = {
  title: "Frequently Asked Questions | PHH Foundation",
  ...
  const faqCategories = [
    {
      ...
      items: [
        {
          question: "What is the PHH Foundation?",
          answer: "PHH Foundation is a non-profit humanitarian organization dedicated to providing hope and relief through educational scholarships, free medical outreach, women empowerment initiatives, and community development projects."
        },
        {
        ...
        },
        {
          ...
          answer: "Yes, PHH Foundation is registered as a non-governmental organization (NGO) under corporate affairs regulations, governed by a board of trustees comprising reputable community leaders and professionals."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "No, volunteering with the PHH Foundation is free. We do not charge volunteers. For remote or local campaigns, basic logistics, water, and lunch are typically provided by the foundation."
        }
      ]
    },
    {
